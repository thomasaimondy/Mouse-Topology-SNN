...
import gym, pybullet, pybulletgym
...
class TWsearchEnv:
    ...
    def load_tw(self,filename):
        ...
        self.lif.AddBiSensoryNeuron(5,25,-0.3,0.3)
        # self.lif.AddBiSensoryNeuron(1,6,-1.0,1.0)
        self.lif.AddBiSensoryNeuron(21,6,-0.02,0.02)
        self.lif.AddBiSensoryNeuron(7,20,-0.2,0.2)
        self.lif.AddBiSensoryNeuron(19,8,-0.03,0.03)
        self.lif.AddBiMotorNeuron(23,24,-1,1)
    ...
    def optimize_and_store(self,worker_id,in_file='tw_pure.bnn'):
        ...
        root_path = 'results121/filter_'+str(self.filter_len)+'_'+str(self.mean_len)
        ...
        self.optimize(ts=datetime.timedelta(hours=20),max_steps=20000)
